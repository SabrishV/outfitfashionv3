...
export default function Order() {
    ...
    const menus = [
        {
            name: <div>All Orders <span className="bg-[#CCEDE8] rounded-[5px] py-[4px] px-[7px]">100</span></div>
        },
        {
            name: <div>Active Orders <span className="bg-[#CCEDE8] rounded-[5px] py-[4px] px-[7px]">2</span></div>
        },
        {
            name: <div>Inactive Orders <span className="bg-[#CCEDE8] rounded-[5px] py-[4px] px-[7px]">2</span></div>
        }
    ];
        ...
        <div className="mt-[30px] w-full">
            <div className="flex justify-between w-full items-center">
                <div className="flex gap-1">
                    <p className="font-[700] text-[20px]">Customer Orders (100)</p>
                </div>
            ...
            <div className="flex gap-2 lg:hidden mt-[20px]">
                            <div onClick={handleClickExport} className="bg-[#00A78B] flex items-center gap-1 text-white py-[10px] px-[20px] cursor-pointer rounded-[7px]">
                                <p>Import</p>
                                <CiExport />
                            </div>
            ...
            <div className="mt-[30px]">
                <div className=" flex flex-col justify-between">
                        ...
                        <div className=" flex gap-3">
                            {menus.map((menu, index) => (
                                ...
                                <button
                                    ...
                                    key={index}
                                    className={` flex items-center align-middle space-x-[5px] ${activeTab === index ? "text-[#008B74] font-[700] border border-b-[#005446] border-l-[white] border-r-[white] border-t-[white]" : " text-[#AEAEAE]"
                                        }  `}
                                >
                    ...
                    <div className="">{OrderData[activeTab].content}</div>
                </div>
            </div>
        </div>
    )
