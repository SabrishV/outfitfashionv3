          ...
          {(pathname.includes("/dashboard")) && (
            <main className=" flex flex-grow">
              ...
              <div className="lg:w-[85%] w-full">
                <FcMenu onClick={handleClick} className="text-[30px] cursor-pointer lg:hidden block absolute top-5 mr-4"/>
                <Navbar 
              ...
              {
                click && (
                  <div className="w-[60%] lg:hidden block absolute z-[1000]">
        ...
        <div className="flex gap-2 lg:justify-start justify-between items-center">
          ...
          <div>
            ...
            <p>Duckui@demo.com</p>
                    ...
                    <MdOutlineCancel onClick={handleClickx} className="text-[30px]"/>
        </div>
      </div>
